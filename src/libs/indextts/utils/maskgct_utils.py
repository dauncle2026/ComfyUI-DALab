...
def build_semantic_model(path_='./models/tts/maskgct/ckpt/wav2vec2bert_stats.pt',model_dir='./models/tts/maskgct/ckpt'):
    semantic_model = Wav2Vec2BertModel.from_pretrained(model_dir)
    semantic_model.eval()
