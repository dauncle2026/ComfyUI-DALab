...
| 模型版本 | 说明 | 下载地址 |
| :--- | :--- | :--- |
| **Qwen Image (FP8)** | 通义万相 2.5 扩散模型 | [下载](https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/tree/main/split_files/diffusion_models) |
...
| 模型版本 | 说明 | 下载地址 |
| :--- | :--- | :--- |
| **Qwen 2.5 VL (FP8)** | 通义千问 2.5 VL 视觉语言模型 | [下载](https://huggingface.co/Comfy-Org/Qwen-Image_ComfyUI/tree/main/split_files/text_encoders) |
